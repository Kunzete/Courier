...
<?php
 ...
 if(isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM user WHERE username='$username' AND Password='$password' AND city = '$city';";
    ...
    if ($result->num_rows > 0) {
      ...
      if ($user_name == $username && $user_pass == $password && $user_city == $city) {
      ...
      echo "<script>alert('No User Found. Please check your city.');</script>";
    }
 }
